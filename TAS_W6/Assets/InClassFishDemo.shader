...
Shader "InClassFishDemo"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float4 appendResult14 = (float4(( ( v.color.b * ( ase_vertex3Pos.z * _BluePositionalAmplitudeScaler ) * temp_output_5_0 * _BlueAmplitude ) + _BlueOffset ) , ( ( _Amplitude * temp_output_5_0 * abs( ( ase_vertex3Pos.x * 1.0 ) ) ) + _AplitudeOffset ) , 0.0 , 0.0));
...
/*ASEBEGIN
Version=16301
-1920;23;1920;1035;3395.659;1150.643;2.649442;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;23;-923.3581,804.2363;Float;False;Constant;_PositionalAmplitudeScaler;Positional Amplitude Scaler;5;0;Create;True;0;0;False;0;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;35;-203.7601,388.5602;Float;False;Property;_BluePositionalAmplitudeScaler;Blue Positional Amplitude Scaler;6;0;Create;True;0;0;False;0;1;0.05;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;36;-336.1231,-546.064;Float;False;Property;_BlueAmplitude;Blue Amplitude;7;0;Create;True;0;0;False;0;1;5;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=DB203F1A9F9C6649CD85A2E15B9980E6919E1537